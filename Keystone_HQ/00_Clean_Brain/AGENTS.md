# AGENTS.md — Keystone Sovereign Agent Fleet [[ARCHITECTURE|Architecture]]
> Last updated: 2026-06-04 by Chronos [[master|Master]] Brain cleanup sweep

## Overview

The Keystone Master Brain is an autonomous AI orchestration system managing **Wayne Stevenson's dual-brand empire**: Keystone [[possibilities|Possibilities]] (construction/PM) and Keystone Recomposition (health protocols, [[music|music]], wellness). It coordinates 13+ specialized agents, self-healing loops via self-evolution, overnight research automation, and multi-platform content publishing.

See also: [[Master_Docs/STATE_OF_THE_EMPIRE|State of the Empire]] · [[DIRECTIVES|Directives]] · Active [[STATE|State]] · [[Master_Docs/INTEGRATION_MAP|Integration Map]]
...
| # | Agent | Brand | [[davinci-resolve-mcp/docs/SKILL|Skill]] File | Purpose |
|---|-------|-------|------------|---------|
...
| 3 | [[local_seo|local_seo]] | Possibilities | `04_keystone_local_seo` | Local SEO domination for Sea-to-Sky corridor. GMB optimization, citation building, ranking strategies. |
| 4 | [[protocol_brand|protocol_brand]] | Protocol | `05_protocol_script_studio` | APOLLO engine. Full-cycle Protocol/Recomposition content: peptide science, serialized scripts, timelines, publishing. |
...
| 7 | [[webmaster|webmaster]] | All | `11_webmaster` | SEO domination, landing pages, Google Console fixes, Knowledge Panel management, blog-to-video traffic loops, cross-brand backlinking. |
| 8 | legal_counsel | All | `12_legal_counsel` | Legal matters, compliance, contract review, dispute resolution. |
| 9 | tax_strategist | All | `[[dynamic_skills/13_tax_strategist|13_tax_strategist]]` | Tax strategies, deductions, financial structuring for both brands. |
...
- **For the full System [[Master_Docs/00_DIRECTORY_STRUCTURE|Directory Structure]]:** Read [[Master_Docs/00_DIRECTORY_STRUCTURE|Directory Structure]]
- **For Active Projects:** Read Active Projects
- **For the [[Master_Docs/SOVEREIGN_MEMORY_ARCHITECTURE|Sovereign Memory Architecture]]:** Read Memory Architecture
