...
OmniSocials Server [[ARCHITECTURE|Architecture]]
...
To circumvent the [[Limitations|limitations]] of the official API—specifically the inability to automate direct inbox messaging—engineers deploy the mcp-server-linkedin package, authored by StickerDaniel. This server Abandons REST APIs entirely. Instead, it utilizes Patchright and Playwright to launch an invisible, headless Chromium browser directly on the host machine.   
