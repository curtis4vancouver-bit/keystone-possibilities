# [[GEMINI|Gemini]] Platform Update: 3.1 Release, Spark Agent, API Features & Integration Guide
...
| **Anthropic [[CLAUDE|Claude]]** | Opus 4.7 / Sonnet 4 | 200K - 1M tokens | Strong coherence over long context |
