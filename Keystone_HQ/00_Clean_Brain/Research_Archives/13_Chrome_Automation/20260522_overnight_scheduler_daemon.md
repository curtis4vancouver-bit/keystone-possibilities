...
**Subject:** Self-Healing SRE Daemons, Task Queue Persistence, Lockfile [[ARCHITECTURE|Architecture]], API Quota Management, and Automated Agent Failover
...
2. **Model Tier Routing**: Use **[[GEMINI|Gemini]] 3.5 Flash** for high-volume research retrieval, initial drafts, and raw summaries (saves 90% of credits). Reserve premium models like **Gemini 3.0 Pro** solely for final synthesis, code verification, and database vector indexing.
