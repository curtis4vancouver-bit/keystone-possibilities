...
| **Smithery** | smithery.ai | Major [[wiki/index|index]] with ranking by activity and reliability |
| **PulseMCP** | pulsemcp.com | Server [[wiki/index|index]] with ranking and stats |
...
- Content creation (captions, hashtags, [[Brand_Constitution/BRAND_VOICE|brand voice]])
...
- Preferences > [[general|General]] > External scripting using > Local
...
- **Community GitHub Repos**: Search for "antigravity skills" or "[[GEMINI|gemini]] cli extensions"
...
### [[davinci-resolve-mcp/docs/SKILL|Skill]] Structure
```
skill_folder/
...
- **Authentication**: OAuth 2.1 with PKCE for remote servers; verify caller [[Brand_Constitution/protocol/IDENTITY|identity]] on every request
