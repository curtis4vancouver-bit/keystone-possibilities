# Deep Research: Research MCP servers for [[music|music]] production and audio — Spotify API, MusicBrainz, SoundCloud, Bandcamp, audio analysis, waveform generation, BPM detection, key detection. What tools exist that an AI agent could use to manage a music brand's catalog, distribution, and analytics?
**Domain:** Mcp Tools
...
Translates a publisher's International Standard Musical Work Code (ISWC) to a MusicBrainz work, bridging the gap between publishing and [[master|master]] rights.
