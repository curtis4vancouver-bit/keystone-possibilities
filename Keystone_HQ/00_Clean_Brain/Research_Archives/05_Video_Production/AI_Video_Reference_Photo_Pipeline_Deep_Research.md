...
## [[Brand_Constitution/protocol/IDENTITY|Identity]] Consistency, Production Workflows & Legal Frameworks (2026)
...
3. This "Consistency Core" prevents [[Brand_Constitution/protocol/IDENTITY|identity]] drift across all video clips
...
5. Use precise prompt [[ARCHITECTURE|architecture]]:
...
6. **Ducker Track FX** → auto-ducks [[music|music]] under dialogue
...
3. **PuLID Adapter (0.8 weight):** Aggressively locks original facial [[Brand_Constitution/protocol/IDENTITY|identity]]
...
> ⚠️ NEVER just add "muscular body" to a text prompt — this causes [[Brand_Constitution/protocol/IDENTITY|identity]] drift and anatomical severing
...
### Keystone [[possibilities|Possibilities]] (Construction Ads)
