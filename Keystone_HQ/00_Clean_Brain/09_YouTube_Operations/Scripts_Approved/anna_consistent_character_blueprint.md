# 👩‍🎤 ANNA: CONSISTENT [[music|MUSIC]] VIDEO CHARACTER BLUEPRINT
*Document Path:* `c:\Users\Curtis\New folder\construction-website\Keystone_HQ\00_Master_Brain\09_YouTube_Operations\Scripts_Approved\anna_consistent_character_blueprint.md`  
*Generated on:* May 21, 2026  
*Model:* Google Labs Flow (Scenebuilder & Whisk Ecosystem)  
...
2. Copy and paste the **[[master|Master]] Character Prompt** (found below) to generate a clean, clear portrait.
