---
id: doc-socialapiportalguide
title: Social Api Portal Guide
type: document
summary: To automate posting to LinkedIn, Facebook, Instagram, and TikTok, we need
  client credentials (Client ID / Client Secret / Client Key) from each pla...
entities:
- Keystone Possibilities
- YouTube
created: '2026-05-20T08:08:04.117206'
updated: '2026-06-14T19:57:36.056423'
---
...
<!-- CONTEXT: Social Api Portal Guide / 1. LinkedIn Developer Portal (Personal & Company Page) -->
...
3. Fill out the application details:
   ...
   - **LinkedIn Page:** Search and link your Keystone [[possibilities|Possibilities]] company page (you must be an admin of this page to link it).
...
<!-- CONTEXT: Social Api Portal Guide / 2. Meta Developer Portal (Facebook Pages & Instagram Business) -->
...
<!-- CONTEXT: Social Api Portal Guide / 4. Automatic Local Token Generation -->
