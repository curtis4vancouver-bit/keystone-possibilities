...
https://youtu.be/FuIubM7iv2I
https://youtu.be/g1H0TQX85t4
https://youtu.be/tUyx1bSYIQU
https://youtu.be/Lix8ct1lCv4
https://youtu.be/jpwkFv7JFMs
https://youtu.be/kC9xEhikZ8U
https://youtu.be/g2H2VopYDag

**Channel ID:** UCMn1f9DTF_iybKmv5WlTm9Q
**Total Views (As of Apr 2026):** 20.2K
**Traffic Split:** 95.3% from Shorts feed. Long-form at ~1K views.

<!-- CONTEXT: Master Links And Music Isrc / MUSIC SYNDICATION & ISRC SYSTEM -->
## MUSIC SYNDICATION & ISRC SYSTEM
- **Distributor:** TooLost (registers ISRC codes globally).
- **Metadata:** MusicBrainz (master ISRC/UPC database).
- **Lyrics:** Musixmatch (100% Wayne-written lyrics).
- **Stems:** Mixed in DaVinci Resolve.
- **Cadence:** 1 album per week via TooLost.
- **Spotify Keywords:** Jazz, Chillout, Ambient, Lounge.

<!-- CONTEXT: Master Links And Music Isrc / SEO & SCHEMA RESOURCES -->
...
- Schema App Guide: https://www.schemaapp.com/schema-markup/how-to-do-schema-markup-for-local-business/
- Google LocalBusiness Docs: https://developers.google.com/search/docs/appearance/structured-data/local-business
- Google Organization Docs: https://developers.google.com/search/docs/appearance/structured-data/organization
<!-- CONTEXT: Master Links And Music Isrc / GOOGLE BUSINESS PROFILE & REVIEWS -->
## GOOGLE BUSINESS PROFILE & REVIEWS
- Direct Google Review Link ([[possibilities|Possibilities]]): https://g.page/r/CeOxwE4SIwZpEAI/review

<!-- CONTEXT: Master Links And Music Isrc / CANADIAN BUSINESS DIRECTORIES & CITATIONS -->
## CANADIAN BUSINESS DIRECTORIES & CITATIONS
- Squamish Chamber: https://www.squamishchamber.com/
- Whistler Chamber: https://business.whistlerchamber.com/
- OrgBook BC: https://orgbook.gov.bc.ca/
- BC Registries: https://www.bcregistry.gov.bc.ca/
- Whitespark: https://whitespark.ca/local-citation-finder/
- BrightLocal Canada: https://www.brightlocal.com/resources/top-citation-sites/location/canada/
- HomeStars: https://homestars.com/
- Houzz: https://houzz.ca/
...
- BC Hydro FOI: https://www.bchydro.com/toolbar/about/accountability-reports/freedom-of-information.html
- Squamish Real Estate Services: https://squamish.ca/business-and-development/real-estate/
