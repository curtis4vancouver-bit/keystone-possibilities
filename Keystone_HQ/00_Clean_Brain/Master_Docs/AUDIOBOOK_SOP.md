...
| **GLP-1** | "G L P one" | Sarcopenia/peptide peptide tracking |
| **semaglutide** | "sema-gloo-tide" | Phonetic spelling override |

<!-- CONTEXT: Audiobook Sop / 2. Custom Pronunciation Lexicons (.PLS) -->
...
<!-- CONTEXT: Audiobook Sop / 3. ElevenLabs Voice Clone Configuration -->
...
<!-- CONTEXT: Audiobook Sop / Phase 2: Mastering & ACX Compliance (Audacity Workflow) -->
...
<!-- CONTEXT: Audiobook Sop / Mastering Step-by-Step Chain (Audacity) -->
...
<!-- CONTEXT: Audiobook Sop / Phase 3: Storefront Deployment (Shopify Starter) -->
...
<!-- CONTEXT: Audiobook Sop / Phase 4: Automated Delivery Integration -->
...
<!-- CONTEXT: Audiobook Sop / Phase 5: Testing & Auditing -->
