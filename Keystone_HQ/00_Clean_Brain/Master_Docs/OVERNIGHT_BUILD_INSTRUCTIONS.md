---
id: doc-overnightbuildinstructions
title: Overnight Build Instructions
type: document
summary: 'Build: 00MasterBrain/core/statestore.py'
entities: []
created: '2026-06-13T22:51:13.703450'
updated: '2026-06-14T19:57:36.044974'
---
# Overnight Build: Hermes → Antigravity Brain Transplant
# =====================================================
# This is the complete build instruction set for the overnight /goal session.
# Read [[Master_Docs/HERMES_BRAIN_TRANSPLANT_REFERENCE|HERMES_BRAIN_TRANSPLANT_REFERENCE]].md for the full technical analysis.
# All code goes into: 00_Master_Brain/
# Test everything before moving to the next phase.

<!-- CONTEXT: Overnight Build Instructions / PHASE 1: SQLite [[STATE|State]] Store (P0) -->
## PHASE 1: SQLite [[STATE|State]] Store (P0)
Build: `00_Master_Brain/core/state_store.py`

1. Create SQLite database at `00_Master_Brain/memory/[[STATE|state]].db`
...
<!-- CONTEXT: Overnight Build Instructions / PHASE 2: Auto-[[davinci-resolve-mcp/docs/SKILL|Skill]] Generator (P0) -->
## PHASE 2: Auto-[[davinci-resolve-mcp/docs/SKILL|Skill]] Generator (P0)
Build: `00_Master_Brain/core/skill_generator.py`
Build: `00_Master_Brain/.[[AGENTS|agents]]/skills/self-learning-engine/[[davinci-resolve-mcp/docs/SKILL|SKILL]].md`

1. [[davinci-resolve-mcp/docs/SKILL|Skill]] format matching Hermes spec (YAML frontmatter + markdown)
2. Validator: name ≤64 chars, description ≤1024, total ≤100K
3. Name regex: ^[a-z0-9][a-z0-9._-]*$
4. Collision detection across all [[davinci-resolve-mcp/docs/SKILL|skill]] directories
5. Atomic write (temp file + os.replace)
6. Auto-detection: "Is this pattern reusable?" heuristic
7. Nudge counter: every N tool calls, consider [[davinci-resolve-mcp/docs/SKILL|skill]] creation
8. Save to: `00_Master_Brain/.[[AGENTS|agents]]/skills/auto-generated/<name>/[[davinci-resolve-mcp/docs/SKILL|SKILL]].md`
9. Usage tracking in `.usage.json`:
   - use_count, view_count, patch_count, last_activity_at, [[STATE|state]], pinned
10. Curator: archive skills unused for 30+ days (never delete)

<!-- CONTEXT: Overnight Build Instructions / PHASE 3: Memory Context Injection (P1) -->
## PHASE 3: Memory Context Injection (P1)
Build: `00_Master_Brain/core/memory_manager.py`
Update: session bootstrap [[davinci-resolve-mcp/docs/SKILL|skill]]
...
<!-- CONTEXT: Overnight Build Instructions / PHASE 6: Self-Knowledge & Correction (P2) -->
...
<!-- CONTEXT: Overnight Build Instructions / PHASE 7: Integration & Testing -->
## PHASE 7: Integration & Testing
1. Create unified `brain_init.py` that initializes all components
2. Update `self_evolution.py` to use new [[STATE|state]] store
3. Update `dream_engine.py` to use conversation compressor
4. Write Antigravity [[davinci-resolve-mcp/docs/SKILL|skill]]: `keystone-self-learning-engine/[[davinci-resolve-mcp/docs/SKILL|SKILL]].md`
5. Test: create a session, add messages, search, compress, generate [[davinci-resolve-mcp/docs/SKILL|skill]]
6. Test: self-repair on corrupted database
7. Test: memory injection on fresh session
8. Save test results to vault
9. Update [[wiki/index|INDEX]].md with new core/ directory

<!-- CONTEXT: Overnight Build Instructions / VERIFICATION CHECKLIST -->
