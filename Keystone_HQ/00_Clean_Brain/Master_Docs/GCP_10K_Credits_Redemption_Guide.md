...
> **Application:** Offsets API and hosting costs for third-party partner models (Anthropic [[CLAUDE|Claude]], Mistral AI, Llama, AI21) running directly inside **Vertex AI Model Garden**.

---

<!-- CONTEXT: Gcp 10K Credits Redemption Guide / 🎯 Section 1: How the $10,000 Credits Work -->
...
*   **Standard GCP Credits vs. Model Garden Credits:** Standard credits offset [[general|general]] VM compute (like Cloud Run or Compute Engine). Model Garden partner credits are specifically applied to the **Vertex AI model registry** to cover endpoints of non-Google foundation models.
...
<!-- CONTEXT: Gcp 10K Credits Redemption Guide / 🛠️ Section 2: Step-by-Step Redemption Procedure -->
## 🛠️ Section 2: Step-by-Step Redemption Procedure

Follow these physical steps on your computer or phone browser to claim and apply your $10,000 promotional balance:

<!-- CONTEXT: Gcp 10K Credits Redemption Guide / Step 1: Open the Google for Startups Portal -->
...
<!-- CONTEXT: Gcp 10K Credits Redemption Guide / Step 2: Retrieve your GFS Promo Key -->
...
<!-- CONTEXT: Gcp 10K Credits Redemption Guide / 🚨 Section 3: Setting Up Safeguards (Budgets & Alerts) -->
...
<!-- CONTEXT: Gcp 10K Credits Redemption Guide / 1. Create a Budget Alarm -->
...
<!-- CONTEXT: Gcp 10K Credits Redemption Guide / 2. Configure Action Thresholds -->
...
> [!TIP]
> **Action Item:** Once you have completed the redemption steps, let me know! I will run our local diagnostic check on `content_engine_mcp.py` to confirm that the Vertex AI API connection is successfully hitting your active billing account.
