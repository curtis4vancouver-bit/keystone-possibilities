...
STEP_FILE = r"C:\Users\Curtis\.gemini\antigravity\brain\55ece092-8436-4c83-924a-2121703c17bd\.system_generated\steps\3248\output.txt"
DOMAIN = "VIDEO_PROD"
TOPIC = "Research the state of AI-generated music videos in 2026. What are the best tools and workflows for creating full-length music videos using AI video generation? How do you sync visual transitions to audio beats programmatically? What are the quality benchmarks that separate amateur from professional AI music videos?"
...
def main():
    ...
    marker = "Architecting the Autonomous Production Pipeline: The State of AI-Generated Music Videos in 2026"
    if marker in text:
