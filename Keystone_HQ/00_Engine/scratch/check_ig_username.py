...
def main():
    ...
    print("Checking Instagram Account Username...")
    ig_id = "17841476508485721"
    url = f"https://graph.facebook.com/v20.0/{ig_id}?fields=username,name&access_token={user_access_token}"
