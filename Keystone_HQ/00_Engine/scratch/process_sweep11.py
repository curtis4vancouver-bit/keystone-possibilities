...
BATCH_ITEMS = [
    {
        ...
        "topic": "GitHub secret scanning and credential leak prevention",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page27_output.json")
    },
    {
        "domain": "security_hardening",
        "topic": "VPN setup for accessing geo-restricted AI services",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page28_output.json")
    },
    {
        "domain": "security_hardening",
        "topic": "Antivirus recommendations that don't interfere with development tools",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page29_output.json")
    }
]
