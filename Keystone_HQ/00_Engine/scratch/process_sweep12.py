...
BATCH_ITEMS = [
    {
        ...
        "topic": "Fusion scripting for text overlays and lower thirds automation",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page30_output.json")
    },
    {
        "domain": "davinci_resolve",
        "topic": "Batch render queue management and output path configuration",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page31_output.json")
    },
    {
        "domain": "davinci_resolve",
        "topic": "Color grading automation and LUT application via scripting",
        "output_file": os.path.join(PROJECT_ROOT, "scratch", "page32_output.json")
    }
]
