...
# Define paths
STEP_OUTPUT_PATH = r"C:\Users\Curtis\.gemini\antigravity\brain\f12c78d2-72b4-40e4-afee-7564ea10b735\.system_generated\steps\2113\output.txt"
...
def main():
    ...
    topic = "Shopify SEO and high-intent organic traffic acquisition strategies for digital goods"
