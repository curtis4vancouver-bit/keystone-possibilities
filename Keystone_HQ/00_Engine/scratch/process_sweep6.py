...
BATCH_ITEMS = [
    {
        ...
        "topic": "Anthropic MCP protocol updates and new features 2026",
        "step_file": r"C:\Users\Curtis\.gemini\antigravity\brain\f12c78d2-72b4-40e4-afee-7564ea10b735\.system_generated\steps\2832\output.txt"
    },
    {
        "domain": "chrome_automation",
        "topic": "Handling CAPTCHAs and bot detection in automated browsing",
        "step_file": r"c:\Users\Curtis\New folder\construction-website\Keystone_HQ\00_Master_Brain\scratch\page13_output.json"
    },
    {
        "domain": "chrome_automation",
        "topic": "Efficient DOM snapshot parsing for data extraction",
        "step_file": r"C:\Users\Curtis\.gemini\antigravity\brain\f12c78d2-72b4-40e4-afee-7564ea10b735\.system_generated\steps\2836\output.txt"
    }
]
...
def clean_and_extract_content(filepath):
    ...
    # The MCP output might be JSON-encoded string or text containing json blocks
