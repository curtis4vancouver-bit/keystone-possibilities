# Check block braces inside inject_schema function
...
block_lines = lines[433:571] # lines 434 to 571 (0-indexed 433 to 570)
...
print(f"Inject Schema block (lines 434-571) - Open braces: {open_count}, Close braces: {close_count}")

# Check lines one by one to see where braces open and close
depth = 0
for idx, line in enumerate(block_lines, 434):
