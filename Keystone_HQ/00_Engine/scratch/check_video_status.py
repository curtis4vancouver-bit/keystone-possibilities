...
def check_video(video_id, token_file):
    ...
    try:
        ...
        if items:
            ...
            print("  Video not found with this token (might be on another channel or not authorized).")
    except Exception as e:
        print(f"  Error: {e}")

if __name__ == "__main__":
    os.chdir(SCRIPT_DIR)
    check_video("-abkt0cDDY4", "youtube_token.json")
    check_video("-abkt0cDDY4", "youtube_token_oac.json")
