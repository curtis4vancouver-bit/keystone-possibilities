...
local_path = r"c:\Users\Curtis\New folder\second-website\astra-child\functions.php"
...
print("update_page_sovereign endpoint added successfully to second-website/astra-child/functions.php!")
