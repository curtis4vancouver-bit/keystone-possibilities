...
def run():
    print("Connecting to Chrome on port 65047...")
    with sync_playwright() as p:
        ...
        print("Connected! Locating Google Flow project page...")
        ...
        for clip_num, text in sorted(PROMPTS.items()):
            ...
            if submit_btn.is_disabled():
                print("WARNING: Create button is disabled! Waiting...")
            ...
            # Wait 8 seconds before next prompt to let queueing complete
            time.sleep(8)
