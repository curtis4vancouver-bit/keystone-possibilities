...
STEP_FILE = r"C:\Users\Curtis\.gemini\antigravity\brain\55ece092-8436-4c83-924a-2121703c17bd\.system_generated\steps\2755\output.txt"
DOMAIN = "YT_ANALYTICS"
TOPIC = "Research how to scrape and analyze YouTube comments, community posts, and audience sentiment programmatically. What APIs and tools allow you to understand what your audience actually wants? How do you identify content requests, complaints, and trending questions from your own channel and competitors?"
...
def main():
    ...
    marker = "Advanced Programmatic Extraction and NLP Analysis of YouTube Engagement Data"
    if marker in text:
