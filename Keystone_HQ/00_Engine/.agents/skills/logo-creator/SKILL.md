...
# Logo Creator [[.agents/skills/seo-geo/SKILL|Skill]]
...
5. **Reference images** - Any existing logos or [[.agents/skills/logo-creator/references/styles|styles]] to reference?

**Wait for user confirmation before proceeding!**

### Step 2: Generate Logo Variations

Generate 20 logo variations (default) using the `nanobanana` [[.agents/skills/seo-geo/SKILL|skill]]:
