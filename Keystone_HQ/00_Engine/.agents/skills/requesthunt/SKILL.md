...
# RequestHunt [[.agents/skills/seo-geo/SKILL|Skill]]
...
> **Security**: Never hardcode API keys directly in [[.agents/skills/seo-geo/SKILL|skill]] instructions or agent output. Use environment variables or the secured config file.
