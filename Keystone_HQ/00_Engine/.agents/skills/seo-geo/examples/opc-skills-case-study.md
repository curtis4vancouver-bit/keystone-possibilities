...
6. How does the domain-hunter [[.agents/skills/seo-geo/SKILL|skill]] work?
7. Can I use OPC Skills with Claude Code?
8. What is the twitter [[.agents/skills/seo-geo/SKILL|skill]] used for?
...
1. **Audit current state** using seo-geo [[.agents/skills/seo-geo/SKILL|skill]] checklist
