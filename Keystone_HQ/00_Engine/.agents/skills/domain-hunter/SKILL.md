---
name: domain-hunter
description: Search domains, compare prices, find promo codes, get purchase recommendations. Use when user wants to buy a domain, check domain prices, find domain deals, compare [[.agents/skills/domain-hunter/references/registrars|registrars]], or search for .ai/.com domains.
---

# Domain Hunter [[.agents/skills/seo-geo/SKILL|Skill]]
...
Use **Twitter [[.agents/skills/seo-geo/SKILL|skill]]** to search registrar accounts:
...
Use **Reddit [[.agents/skills/seo-geo/SKILL|skill]]** to search domain communities:
...
5. **WHOIS privacy** is free at most [[.agents/skills/domain-hunter/references/registrars|registrars]] (Cloudflare, Namecheap, Porkbun)

## References

- [references/registrars.md](./references/registrars.md) - Detailed registrar comparison
- [references/spaceship-api.md](./references/spaceship-api.md) - [[.agents/skills/domain-hunter/references/spaceship-api|Spaceship API]] for automated domain operations
