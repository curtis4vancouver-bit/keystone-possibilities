...
- Squamish
---
# KEYSTONE PWA COMMAND CENTER: SYSTEM ARCHITECTURE
...
- **Admin/PM (Wayne):** Full read/write access. Can create projects, assign trades, approve milestones, and upload master blueprints.
...
<!-- CONTEXT: Pwa Command Center / 6. GEMINI AI AUTOMATION INTEGRATION (Future "Smart" Layer) -->
