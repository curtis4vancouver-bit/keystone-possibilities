...
def get_numeric_prefix(filename):
    """Extracts numeric prefix to properly sort 'A1.mp4', 'A2.mp4', 'B1.jpeg' etc."""
    match = re.search(r'(\d+)', filename)
    return int(match.group(1)) if match else 9999

def assemble_project():
    project_name = "POSS_003"
    timeline_name = "POSS_003_Timeline"
    desktop_dir = r"C:\Users\Curtis\Desktop\SHORT_035_squamish_permit_block"
    ...
    pm.SaveProject()
    print("SUCCESS: POSS_003 timeline assembly complete!")
