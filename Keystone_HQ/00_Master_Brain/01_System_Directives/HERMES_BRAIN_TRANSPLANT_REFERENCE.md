...
<!-- CONTEXT: Hermes Brain Transplant Reference / 4. AUTO-SKILL GENERATION (tools/skill_manager_tool.py) -->
## 4. AUTO-SKILL GENERATION (tools/skill_manager_tool.py)

<!-- CONTEXT: Hermes Brain Transplant Reference / Skill Format -->
### Skill Format
```yaml
---
...
- Periodically prompts: "Should this become a skill?"
...
| Skill manager | hermes-agent/tools/skill_manager_tool.py | ~30KB |
