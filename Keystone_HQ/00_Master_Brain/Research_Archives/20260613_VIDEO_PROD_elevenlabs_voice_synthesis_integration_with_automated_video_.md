...
def assemble_audio_pipeline(audio_data_list, project_fps=24):
    ...
    for idx, item in enumerate(imported_items):
        ...
        # Advance the record frame index for the subsequent sequential chunk
