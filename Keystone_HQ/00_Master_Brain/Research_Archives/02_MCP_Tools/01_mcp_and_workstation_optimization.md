...
list_tabs	Retrieves a comprehensive index of all active terminal sessions.	No parameters required.	Returns an array of objects detailing window_id, name, and active status.
...
# Globally installing the Gemini CLI for prebuilt extension management
...
JSON
{
  "mcpServers": {
    ...
    "terminally-mcp": {
      "command": "node",
      "args": ["/absolute/path/to/terminally-mcp/build/index.js"]
    },
    "toolbox-postgres": {
      "command": "npx",
      "args": [
