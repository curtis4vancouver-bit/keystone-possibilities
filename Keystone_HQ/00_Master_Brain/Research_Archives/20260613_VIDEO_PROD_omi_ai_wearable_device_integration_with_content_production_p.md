...
for clip in synced_clips:
    ...
    if timeline_items:
        for item in timeline_items:
            # SetLUT parameter 1 indicates the node index (1-based in modern Resolve)
