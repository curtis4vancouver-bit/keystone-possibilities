...
### Music Video Assembly (DaVinci Resolve)
...
### Characters
- Ana Stevenson: DJ character, NEVER speaks, Recomposition Music only
- Victoria: Interviewer, Protocol + Possibilities
...
### Skill Location
All of this is documented in: keystone_short_production_pipeline/SKILL.md (Phase 2B + Phase 3M sections)
